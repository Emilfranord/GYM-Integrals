...
class GlassFunction implements Functor{
  ...
  GlassFunction(){
    //this.functions = {new Inverse(0.5, 1), new Exponential(1500, 0.4), new SecondDegreePolynomial(-1, 19, -82.5), new Tangens(1, 1.1)};
    //this.breaks = {0, 1.97046, 6.91583, 11.9898, 13};
